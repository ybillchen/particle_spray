...
We provide notebooks to generate mock streams using the Chen+24 model via `gala`, `galax`, and `agama` (`galpy` coming soon). Checkout these notebooks and follow the instructions therein!
